...
/obj/item/weapon/gun/projectile/shotgun/pump/m90_innie
	name = "Modified M90 shotgun"
	desc = "Originally a UNSC Weapon but has been modified with a custom wooden stock. Etched into the stock reads 'FUCK UNSC'. Has an inbuilt side mounted flashlight."
	icon = 'code/modules/halo/weapons/icons/Weapon Sprites.dmi'
	icon_state = "urfm90"
	item_state = "urfm90"
	fire_sound = 'code/modules/halo/sounds/Shotgun_Shot_Sound_Effect.ogg'
